...
export const THEME_BOOK_FEEL = {
  ...
  default: {
    ...
    light: {
      ...
      frontFill: 0xfff6ec, frontFillI: 0.16, frontFillPos: [-3.0, 1.8, 6.4],
  ...
  pixel: {
    ...
    light: {
      ...
      frontFill: 0xeef6f4, frontFillI: 0.16, frontFillPos: [-3.0, 1.8, 6.4],
