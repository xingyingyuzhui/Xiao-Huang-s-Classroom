...
export const THEME_BOOK_FEEL = {
  ...
  default: {
    front: { roughness: 0.2, metalness: 0.03, clearcoat: 0.72, clearcoatRoughness: 0.16, envMapIntensity: 0.46, bumpScale: 0.005 },
    back: { roughness: 0.3, clearcoat: 0.45, clearcoatRoughness: 0.24, envMapIntensity: 0.34, bumpScale: 0.0045 },
    edge: { roughness: 0.4, metalness: 0.05, clearcoat: 0.32, clearcoatRoughness: 0.36, envMapIntensity: 0.32, bumpScale: 0.006 },
    spine: { roughness: 0.5, metalness: 0.02, clearcoat: 0.22, clearcoatRoughness: 0.5, envMapIntensity: 0.3, bumpScale: 0.012, cloth: true },
    exposure: 1.22,
    light: {
      hemi: 0xd4e4f6, hemiI: 0.52, hemiGround: 0xc4bdb2,
      key: 0xfffdf8, keyI: 1.72,
      fill: 0xdce8f6, fillI: 0.42,
      rim: 0xb8d0e8, rimI: 0.32,
      studio: 0xf4f8fc, studioI: 0.48,
      glow: 0xfff4ea, glowI: 0.26,
      frontFill: 0xfff6ec, frontFillI: 0.34, frontFillPos: [0, 1.4, 7.5],
      keyPos: [4.0, 6.2, 5.6], fillPos: [-4.8, 2.2, 4.0], rimPos: [-2.0, 3.0, -5.2],
      studioPos: [-0.6, 7.8, 3.2], glowPos: [0.35, 0.4, 2.2],
    },
  },
  stationery: {
    front: { roughness: 0.48, metalness: 0.02, clearcoat: 0.2, clearcoatRoughness: 0.58, envMapIntensity: 0.44, bumpScale: 0.009 },
    back: { roughness: 0.55, clearcoat: 0.12, clearcoatRoughness: 0.68, envMapIntensity: 0.32, bumpScale: 0.007 },
    edge: { roughness: 0.58, metalness: 0.02, clearcoat: 0.1, clearcoatRoughness: 0.72, envMapIntensity: 0.3, bumpScale: 0.009 },
    spine: { roughness: 0.68, metalness: 0.01, clearcoat: 0.08, clearcoatRoughness: 0.78, envMapIntensity: 0.28, bumpScale: 0.016, cloth: true },
    exposure: 1.22,
    light: {
      hemi: 0xf4e6d0, hemiI: 0.52, hemiGround: 0xc8a880,
      key: 0xfff6e8, keyI: 1.66,
      fill: 0xf0dcc0, fillI: 0.44,
      rim: 0xe0b890, rimI: 0.28,
      studio: 0xffecd4, studioI: 0.46,
      glow: 0xffe2b8, glowI: 0.24,
      frontFill: 0xfff2de, frontFillI: 0.4, frontFillPos: [0, 1.4, 7.5],
      keyPos: [3.8, 5.8, 5.4], fillPos: [-4.4, 2.4, 3.8], rimPos: [-1.8, 2.8, -5.0],
      studioPos: [-0.8, 7.4, 3.0], glowPos: [0.25, 0.35, 2.1],
    },
  },
  reagent: {
    front: { roughness: 0.18, metalness: 0.04, clearcoat: 0.82, clearcoatRoughness: 0.12, envMapIntensity: 0.46, bumpScale: 0.0045 },
    back: { roughness: 0.28, clearcoat: 0.52, clearcoatRoughness: 0.2, envMapIntensity: 0.34, bumpScale: 0.004 },
    edge: { roughness: 0.35, metalness: 0.06, clearcoat: 0.4, clearcoatRoughness: 0.3, envMapIntensity: 0.34, bumpScale: 0.005 },
    spine: { roughness: 0.42, metalness: 0.03, clearcoat: 0.35, clearcoatRoughness: 0.38, envMapIntensity: 0.3, bumpScale: 0.008, cloth: false },
    exposure: 1.2,
    light: {
      hemi: 0xece2d4, hemiI: 0.5, hemiGround: 0xa89888,
      key: 0xfff8f0, keyI: 1.7,
      fill: 0xe8d8c4, fillI: 0.4,
      rim: 0xd0bc9c, rimI: 0.3,
      studio: 0xfff0dc, studioI: 0.44,
      glow: 0xf0d4b0, glowI: 0.22,
      frontFill: 0xfff4e8, frontFillI: 0.32, frontFillPos: [0, 1.4, 7.5],
      keyPos: [4.1, 6.0, 5.2], fillPos: [-4.6, 2.0, 3.6], rimPos: [-2.2, 2.6, -5.1],
      studioPos: [-1.0, 7.6, 2.8], glowPos: [0.3, 0.3, 2.0],
    },
  },
  blackboard: {
    front: { roughness: 0.7, metalness: 0.01, clearcoat: 0.08, clearcoatRoughness: 0.85, envMapIntensity: 0.42, bumpScale: 0.012 },
    back: { roughness: 0.76, clearcoat: 0.05, clearcoatRoughness: 0.88, envMapIntensity: 0.3, bumpScale: 0.01 },
    edge: { roughness: 0.78, metalness: 0.01, clearcoat: 0.05, clearcoatRoughness: 0.9, envMapIntensity: 0.28, bumpScale: 0.012 },
    spine: { roughness: 0.82, metalness: 0.01, clearcoat: 0.04, clearcoatRoughness: 0.92, envMapIntensity: 0.26, bumpScale: 0.018, cloth: true },
    exposure: 1.28,
    light: {
      hemi: 0xd8eadc, hemiI: 0.54, hemiGround: 0x7a8c78,
      key: 0xf6faf4, keyI: 1.66,
      fill: 0xd0e4d0, fillI: 0.4,
      rim: 0xa8d0b0, rimI: 0.28,
      studio: 0xe8f4e4, studioI: 0.42,
      glow: 0xdcecc8, glowI: 0.22,
      frontFill: 0xf2f8ec, frontFillI: 0.44, frontFillPos: [0, 1.4, 7.5],
      keyPos: [3.6, 6.4, 5.5], fillPos: [-4.2, 2.5, 4.0], rimPos: [-1.6, 3.2, -5.3],
      studioPos: [-0.5, 8.0, 3.0], glowPos: [0.2, 0.45, 2.15],
    },
  },
  pixel: {
    front: { roughness: 0.34, metalness: 0.03, clearcoat: 0.38, clearcoatRoughness: 0.3, envMapIntensity: 0.44, bumpScale: 0.0035 },
    back: { roughness: 0.4, clearcoat: 0.3, clearcoatRoughness: 0.35, envMapIntensity: 0.32, bumpScale: 0.003 },
    edge: { roughness: 0.38, metalness: 0.03, clearcoat: 0.28, clearcoatRoughness: 0.32, envMapIntensity: 0.32, bumpScale: 0.004 },
    spine: { roughness: 0.42, metalness: 0.02, clearcoat: 0.26, clearcoatRoughness: 0.38, envMapIntensity: 0.28, bumpScale: 0.006, cloth: false },
    exposure: 1.22,
    light: {
      hemi: 0xc0d8d8, hemiI: 0.52, hemiGround: 0x687e7e,
      key: 0xffffff, keyI: 1.72,
      fill: 0xaed8d0, fillI: 0.38,
      rim: 0x78c8b8, rimI: 0.34,
      studio: 0xe8f4f4, studioI: 0.44,
      glow: 0xffc0c8, glowI: 0.2,
      frontFill: 0xeef6f4, frontFillI: 0.34, frontFillPos: [0, 1.4, 7.5],
