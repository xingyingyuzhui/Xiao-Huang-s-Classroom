...
const PALETTE = {
  chemistry: ['#34d399', '#6ee7b7', '#a7f3d0', '#fbbf24', '#0f766e', '#f8fafc'],
  physics: ['#38bdf8', '#818cf8', '#c4b5fd', '#f0abfc', '#1e3a8a', '#e0f2fe'],
  biology: ['#4ade80', '#86efac', '#bbf7d0', '#fde68a', '#14532d', '#f8fafc'],
  mathematics: ['#fbbf24', '#fde68a', '#fdba74', '#e2e8f0', '#92400e', '#fffbeb'],
  math: ['#fbbf24', '#fde68a', '#fdba74', '#e2e8f0', '#92400e', '#fffbeb'],
  default: ['#93c5fd', '#bfdbfe', '#fbcfe8', '#f8fafc', '#1e3a5f', '#60a5fa'],
};
